...
"[project]/node_modules/@firebase/storage/dist/index.cjs.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @internal
 */ function invalidRootOperation(name) {
    return new StorageError(exports.StorageErrorCode.INVALID_ROOT_OPERATION, "The operation '" + name + "' cannot be performed on a root reference, create a non-root " + "reference using child, such as .child('file.png').");
}
/**
 * @param format - The format that was not valid.
 * @param message - A message describing the format violation.
...
//# sourceMappingURL=node_modules_%40firebase_storage_dist_0qit6s8._.js.map