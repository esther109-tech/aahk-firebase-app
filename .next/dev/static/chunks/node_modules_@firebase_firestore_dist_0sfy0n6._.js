...
"[project]/node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js [app-client] (ecmascript) <export aX as getFirestore>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getFirestore",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$fe7037b3$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aX"]
]);
...
var common = __turbopack_context__.r("[project]/node_modules/@firebase/firestore/dist/common-7de8024a.cjs.js [app-client] (ecmascript)");
var util = __turbopack_context__.r("[project]/node_modules/@firebase/util/dist/index.cjs.js [app-client] (ecmascript)");
__turbopack_context__.r("[project]/node_modules/@firebase/webchannel-wrapper/dist/bloom-blob/bloom_blob_es2018.js [app-client] (ecmascript)");
__turbopack_context__.r("[project]/node_modules/@firebase/logger/dist/index.cjs.js [app-client] (ecmascript)");
__turbopack_context__.r("[project]/node_modules/@firebase/webchannel-wrapper/dist/webchannel-blob/webchannel_blob_es2018.js [app-client] (ecmascript)");
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _parse(t) {
        const e = common.__PRIVATE_newUserDataReader(t.firestore), n = function __PRIVATE_newQueryFilter(t, e, n, r, s, a, o) {
            ...
            } else "in" /* Operator.IN */  !== a && "not-in" /* Operator.NOT_IN */  !== a && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */  !== a || __PRIVATE_validateDisjunctiveFilterElements(o, a), i = common.__PRIVATE_parseQueryValue(n, e, o, /* allowArrays= */ "in" /* Operator.IN */  === a || "not-in" /* Operator.NOT_IN */  === a);
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
    if (n[0] = util.getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(t, e, n, r, s) {
        ...
        // results.
        for (const n of common.__PRIVATE_queryNormalizedOrderBy(t))if (n.field.isKeyField()) a.push(common.__PRIVATE_refValue(e, r.key));
        else {
 ...
 */ class QuerySnapshot {
     ...
     */ toJSON() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const t = {};
        t.type = QuerySnapshot._jsonSchemaVersion, t.bundleSource = "QuerySnapshot", t.bundleName = common.__PRIVATE_AutoId.newId(), this._firestore._databaseId.database, this._firestore._databaseId.projectId;
        const e = [], n = [], r = [];
...
function querySnapshotFromJSON(t, e, n) {
    if (common.__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
        ...
        const d = common.ViewSnapshot.fromInitialDocuments(i, h, common.__PRIVATE_documentKeySet(), /* fromCache= */ !1, /* hasCachedResults= */ !1), p = new common.Query(t, n || null, i);
 ...
 */ class WriteBatch {
    /** @hideconstructor */ constructor(t, e){
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, this._dataReader = common.__PRIVATE_newUserDataReader(t);
    }
    set(t, e, n) {
    ...
    update(t, e, n, ...r) {
        ...
        let a;
        return a = "string" == typeof (e = util.getModularInstance(e)) || e instanceof common.FieldPath ? common.__PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", s._key, e, n, r) : common.__PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", s._key, e), this._mutations.push(a.toMutation(s._key, common.Precondition.exists(!0))), this;
    }
    /**
 ...
 */ class Transaction$1 {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
        let a;
        return a = "string" == typeof (e = util.getModularInstance(e)) || e instanceof common.FieldPath ? common.__PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", s._key, e, n, r) : common.__PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", s._key, e), this._transaction.update(s._key, a), this;
    }
    /**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
 ...
 */ function getDocFromCache(t) {
    ...
    return common.__PRIVATE_firestoreClientGetDocumentFromLocalCache(n, t._key).then((n)=>new DocumentSnapshot(e, r, t._key, n, new SnapshotMetadata(null !== n && n.hasLocalMutations, /* fromCache= */ !0), t.converter));
}
/**
...
function setDoc(t, e, n) {
    ...
    return executeWrite(r, [
        common.__PRIVATE_parseSetData(o, "setDoc", t._key, s, null !== t.converter, n).toMutation(t._key, common.Precondition.none())
    ]);
}
function updateDoc(t, e, n, ...r) {
    ...
    return executeWrite(s, [
        i.toMutation(t._key, common.Precondition.exists(!0))
    ]);
}
/**
 ...
 */ function deleteDoc(t) {
    return executeWrite(common.__PRIVATE_cast(t.firestore, common.Firestore), [
        new common.__PRIVATE_DeleteMutation(t._key, common.Precondition.none())
    ]);
}
/**
 ...
 */ function addDoc(t, e) {
    ...
    return executeWrite(n, [
        common.__PRIVATE_parseSetData(o, "addDoc", r._key, s, null !== t.converter, {}).toMutation(r._key, common.Precondition.exists(!1))
    ]).then(()=>r);
}
 ...
 */ !function __PRIVATE_registerFirestore(h, d = !0) {
    ...
    }, "PUBLIC").setMultipleInstances(!0)), app.registerVersion(Ut, Ht, h), // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
...
"[project]/node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js [app-client] (ecmascript) <export aO as collection>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "collection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$fe7037b3$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aO"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$fe7037b3$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js [app-client] (ecmascript)");
}),
"[project]/node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js [app-client] (ecmascript) <export a$ as serverTimestamp>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "serverTimestamp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$fe7037b3$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a$"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$fe7037b3$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/common-fe7037b3.esm.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=node_modules_%40firebase_firestore_dist_0sfy0n6._.js.map